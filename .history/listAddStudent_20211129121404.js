...
function ajouterEtudiant() {
    ...
    let exist = etudiant.length && JSON.parse(localStorage.getItem('Etudiants')).some(data => data.nom == nomEtudiant.value.toUpperCase() && data.prenom == prenomEtudiant.value.toUpperCase())
    etudiant.push({
